...
class Prompt2PromptAttnProcessor:
    r"""
    Default processor for performing attention-related computations.
    """

    def __init__(self, controller: Callable, place_in_unet: str):
    ...
    def __call__(
        ...
        is_cross = encoder_hidden_states is not None  # used for prompt2prompt
